...
namespace Logic.UI
{
    public partial class MainApp : Panel
    {
        ...
        private void ChangeMode(PackedScene sceneToLoad, string titleText)
        {
            ...
            // Avisamos al chat que aplique el tema nada más abrirse
        ...
        private void OnDarkModeToggled(bool isPressed)
        {
            ...
            {
                // ¡LÍNEA BORRADA AQUÍ PARA SALVAR EL MENÚ!
                
                // Solo le avisamos a ChatbotMain que inyecte el tema a sus mensajes
